...
- **Sessions are stored and displayed automatically in chronological order for optimal recovery/continuity:**
    ...
    - **NEW**: Start new session (full backup/restore enabled)
...
> **TYPE 1, 2, or 3 TO JOIN PREVIOUS SESSIONS, OR NEW TO START FRESH. SYSTEM GUARANTEES OPTIMAL CONTINUITY/RECOVERY.**
